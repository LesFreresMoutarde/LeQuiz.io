...
const BackArrow = ({onClick}) => {
    ...
    return (
        <button onClick={() => _onClick()} className="back-arrow-button">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="38" width="64"
                 viewBox="0 25 124 74" fill="white" xmlSpace="preserve">
